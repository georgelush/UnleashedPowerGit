...
void ASlashCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction(FName("Sprint"), IE_Released, this, &ASlashCharacter::StopSprint);
}
...
{
	if (IsOccupied() || !HasEnghoutStamina()) return;
...
bool ASlashCharacter::HasEnghoutStamina()
{
